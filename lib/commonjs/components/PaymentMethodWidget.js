...
var _PaymentMethodWebView = require("../webview/PaymentMethodWebView");
...
function PaymentMethodWidget({
  ...
  const [scriptForOnCancel, setScriptForOnCancel] = (0, _react.useState)(null);
  (0, _react.useEffect)(() => {
  ...
  }, /*#__PURE__*/_react.default.createElement(_RequestPaymentsModal.RequestPaymentsModal, {
  ...
  }), /*#__PURE__*/_react.default.createElement(_PaymentMethodWebView.PaymentMethodWebView, {
